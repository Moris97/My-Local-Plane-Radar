...
// Bucket keys arrive already in the server's local time (see
// time-buckets.js) -- this is a pure reformat, deliberately not a timezone
// conversion, which would shift an already-local key a second time.
